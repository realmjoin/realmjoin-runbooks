...
- **Type**: Microsoft Graph
  ...
  - Channel.ReadBasic.All *(optional: Group, team and channel names in the output)*
  - GroupMember.Read.All *(optional: Group, team and channel names in the output)*
  - Team.ReadBasic.All *(optional: Group, team and channel names in the output)*
