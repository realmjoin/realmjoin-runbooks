...
|  |  |  |  |  |  | CallerName | ✓ | String | Name of the user who started the runbook. Set by the portal and recorded for auditing. |
|  |  | Rename Devices By Group Tag (Scheduled) | Name Autopilot devices after their group tag and serial number | - **Type**: Microsoft Graph<br>&emsp;- DeviceManagementManagedDevices.ReadWrite.All<br>&emsp;- DeviceManagementServiceConfig.ReadWrite.All<br>&emsp;- DeviceManagementManagedDevices.PrivilegedOperations.All<br> |  | NameTemplate |  | String | Pattern of the computer name. %GROUPTAG% is replaced by the Autopilot group tag and %SERIAL% by the serial number; other characters stay as typed. Letters, digits and hyphens only, 15 characters at most after replacement. |
...
|  |  |  |  |  |  | CallerName | ✓ | String | Name of the user who started the runbook. Set by the portal and recorded for auditing. |
|  | Phone | Add Or Remove Call Queue Agents | Add or remove agents of a Teams call queue | - **Type**: Microsoft Graph<br>&emsp;- Organization.Read.All<br>&emsp;- Channel.ReadBasic.All *(optional: Group, team and channel names in the output)*<br>&emsp;- GroupMember.Read.All *(optional: Group, team and channel names in the output)*<br>&emsp;- Team.ReadBasic.All *(optional: Group, team and channel names in the output)*<br> | - Teams Administrator<br> | CallQueueName | ✓ | String | Exact name of the call queue as shown in the Teams admin center. Upper and lower case do not matter, but the name has to match exactly one queue. |
...
|  |  |  |  |  |  | CallerName | ✓ | String | Name of the user who started the runbook. Set by the portal and recorded for auditing. |
|  |  | Add Or Remove Call Queue Authorized Users | Add or remove authorized users of a Teams call queue | - **Type**: Microsoft Graph<br>&emsp;- Organization.Read.All<br> | - Teams Administrator<br> | CallQueueName | ✓ | String | Exact name of the call queue as it is shown in the Teams admin center. Upper and lower case do not matter. |
...
|  |  |  |  |  |  | CallerName | ✓ | String | Name of the user who started the runbook. Set by the portal and recorded for auditing. |
|  |  | Get Teams Phone Number Assignment | Check whether a phone number is assigned in Microsoft Teams | - **Type**: Microsoft Graph<br>&emsp;- Organization.Read.All<br> | - Teams Administrator<br> | PhoneNumber | ✓ | String | Number in international format without spaces, for example +49321987654, optionally with an extension as +49321987654;ext=123. |
|  |  |  |  |  |  | CallerName | ✓ | String | Name of the user who started the runbook. Set by the portal and recorded for auditing. |
