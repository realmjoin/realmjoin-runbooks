...
param(
    ...
    [string] $sendAlertFrom = "support@glueckkanja.com"
)
...
$pimActivations = Invoke-RjRbRestMethodGraph -Resource "/beta/auditLogs/directoryAudits?`$filter=activityDisplayName eq 'Add member to role completed (PIM activation)' and activityDateTime ge $startDate and activityDateTime le $endDate" -ErrorAction SilentlyContinue
