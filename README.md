...
- [Org](docs/org/README.md)
  ...
  - [Devices](docs/org/README.md#org-devices)
    ...
    - [List Mobile Devices](docs/org/devices/list-mobile-devices.md)
  ...
  - [General](docs/org/README.md#org-general)
    ...
    - [Monitor Service Health (Scheduled)](docs/org/general/monitor-service-health_scheduled.md)
    ...
    - [Report Intune Enrollment Readiness](docs/org/general/report-intune-enrollment-readiness.md)
...
- [User](docs/user/README.md)
  ...
  - [General](docs/user/README.md#user-general)
    ...
    - [Check Intune Enrollment Readiness](docs/user/general/check-intune-enrollment-readiness.md)
