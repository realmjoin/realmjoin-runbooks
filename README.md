...
- [Org](docs/org/README.md)
  - [Applications](docs/org/README.md#org-applications)
    ...
    - [Report Expiring Application Credentials (Scheduled)](docs/org/applications/report-expiring-application-credentials-(scheduled).md)
  ...
  - [Devices](docs/org/README.md#org-devices)
    ...
    - [Delete Stale Devices (Scheduled)](docs/org/devices/delete-stale-devices-(scheduled).md)
    ...
    - [Report Stale Devices (Scheduled)](docs/org/devices/report-stale-devices-(scheduled).md)
    - [Report Users With More Than 5-Devices](docs/org/devices/report-users-with-more-than-5-devices.md)
    - [Sync Device Serialnumbers To Entraid (Scheduled)](docs/org/devices/sync-device-serialnumbers-to-entraid-(scheduled).md)
  - [General](docs/org/README.md#org-general)

    - [Add Devices Of Users To Group (Scheduled)](docs/org/general/add-devices-of-users-to-group-(scheduled).md)
    ...
    - [Assign Groups By Template (Scheduled)](docs/org/general/assign-groups-by-template-(scheduled).md)
    ...
    - [Check Aad Sync Status (Scheduled)](docs/org/general/check-aad-sync-status-(scheduled).md)
    ...
    - [Enrolled Devices Report (Scheduled)](docs/org/general/enrolled-devices-report-(scheduled).md)
    ...
    - [Export Cloudpc Usage (Scheduled)](docs/org/general/export-cloudpc-usage-(scheduled).md)
    ...
    - [Report Apple Mdm Cert Expiry (Scheduled)](docs/org/general/report-apple-mdm-cert-expiry-(scheduled).md)
    - [Report License Assignment (Scheduled)](docs/org/general/report-license-assignment-(scheduled).md)
    - [Report Pim Activations (Scheduled)](docs/org/general/report-pim-activations-(scheduled).md)
  ...
  - [Mail](docs/org/README.md#org-mail)
    ...
    - [Hide Mailboxes (Scheduled)](docs/org/mail/hide-mailboxes-(scheduled).md)
  ...
  - [Security](docs/org/README.md#org-security)
    ...
    - [List Pim Rolegroups Without Owners (Scheduled)](docs/org/security/list-pim-rolegroups-without-owners-(scheduled).md)
